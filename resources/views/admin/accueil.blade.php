						...
						<div class="tab-pane active" id="home-1" role="tabpanel" aria-expanded="true">
							<form>
								...
								<div class="add-options-message">
									...
									<button   class="btn btn-md-2 btn-border-think btn-transparent c-grey">Annuler</button>
				...
				<div class="ui-block">
					...
					<article class="hentry post has-post-thumbnail">
						...
						<div class="post__author author vcard inline-items">
							<img src="{{asset('assets/img/avatar2-sm.jpg')}}" alt="author">
						...
						<div class="control-block-button post-control-button">
							...
							<a href="#" class="btn btn-control">
								<svg class="olymp-like-post-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg#olymp-like-post-icon')}}"></use></svg>
							</a>
