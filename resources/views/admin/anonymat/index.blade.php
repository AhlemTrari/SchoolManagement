				...
				<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td>
							<center>
								<a href="{{url('admin/anonymat/show')}}" class="btn btn-control bg-grey" style="height:40px; width: 40px"><i class="fas fa-user"></i></a>
									...
									<div class="modal-body">
										...
										<div class="edit-my-poll-head bg-primary">
											<div class="head-content">
												<h2 class="title">Modifier agent anonymat</h2>
											</div>

											<img class="poll-img" style = "width: 20%" src="{{asset('assets/avatars/user.png')}}" alt="screen">
										</div>
