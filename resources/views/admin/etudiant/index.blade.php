				...
				<table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<a href="#edit{{$etudiant->id}}Modal" class="btn btn-control bg-breez" data-toggle="modal"><i class="fas fa-user-edit"></i></a>
							<a href="#supprimer{{ $etudiant->id }}Modal" class="btn btn-control bg-orange" data-toggle="modal"><i class="fas fa-user-times"></i></a>
							</center>
