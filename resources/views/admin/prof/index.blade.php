                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <center>
								...
								<a href="#edit{{ $prof->id }}Modal" class="btn btn-control bg-breez" data-toggle="modal" ><i class="fas fa-user-edit"></i></a>
								<a href="#supprimer{{ $prof->id }}Modal" class="btn btn-control bg-orange" data-toggle="modal"><i class="fas fa-user-times"></i></a>
							</center>
                            </td>
                        </tr>
