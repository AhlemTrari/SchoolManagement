    ...
    <div class="row display-flex">
        <div class="col col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="landing-content">
                ...
                <p>Utiliser UniSoft pour faciliter la gestion universitaire , collaborer avec vos étudiants et rester en contact avec l'administration.
                </p>
        ...
        <div class="col col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12">
            ...
            <div class="registration-login-form">
                <form method="POST" action="{{ route('enseignant.login.submit') }}">
                @csrf
                    <div class="container">
