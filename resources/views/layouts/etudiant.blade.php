	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1-responsive">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
				...
				<div class="author-page author vcard inline-items">
					...
					<a href="02-ProfilePage.html" class="author-name fn">
						<div class="author-title">
							Nom prenom <svg class="olymp-dropdown-arrow-icon"><use xlink:href="{{asset('assets/svg-icons/sprites/icons.svg#olymp-dropdown-arrow-icon')}}"></use></svg>
						</div>
			...
			<ul class="account-settings">
				...
				<li>
					<a href="{{ route('etudiant.logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
						<svg class="olymp-logout-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-logout-icon"></use></svg>

						<span>Se déconnecter</span>
					</a>
					<form id="logout-form" action="{{ route('etudiant.logout') }}" method="POST" style="display: none;">
                                        @csrf
                                    </form>
				</li>
			</ul>
